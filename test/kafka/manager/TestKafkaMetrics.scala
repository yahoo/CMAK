...
import kafka.manager.model.{Kafka_2_0_0, Kafka_1_1_0, Kafka_1_0_0, Kafka_0_11_0_2, Kafka_0_10_2_1, Kafka_0_10_1_1, Kafka_0_10_0_1, Kafka_0_9_0_1, Kafka_0_8_2_1, Kafka_0_8_1_1}
...
class TestKafkaMetrics extends FunSuite {
  ...
  test("generate broker metric name correctly for kafka 2.0.0") {
    val on = KafkaMetrics.getObjectName(Kafka_2_0_0,"MessagesInPerSec",None)
    assert(on.getCanonicalName === """kafka.server:name=MessagesInPerSec,type=BrokerTopicMetrics""")
  }
  ...
  test("generate topic metric name correctly for kafka 2.0.0") {
    val on = KafkaMetrics.getObjectName(Kafka_2_0_0,"MessagesInPerSec",Some("topic"))
    assert(on.getCanonicalName === """kafka.server:name=MessagesInPerSec,topic=topic,type=BrokerTopicMetrics""")
  }
}
